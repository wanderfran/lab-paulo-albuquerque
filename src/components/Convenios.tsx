            ...
            <div>
              ...
              <div className="flex gap-2 sm:gap-4">
                <a
                  ...
                  className="inline-flex flex-1 sm:flex-initial items-center justify-center gap-1.5 sm:gap-2 bg-green-500 hover:bg-green-600 text-white px-3 sm:px-6 py-3 rounded-xl text-sm sm:text-base font-semibold transition-all whitespace-nowrap"
                >
                  ...
                  <span>Consultar<span className="hidden sm:inline"> Convênio</span></span>
                </a>
                <a
                  href="tel:+559632254288"
                  className="inline-flex flex-1 sm:flex-initial items-center justify-center gap-1.5 sm:gap-2 bg-navy-900 hover:bg-navy-800 text-white px-3 sm:px-6 py-3 rounded-xl text-sm sm:text-base font-semibold transition-all whitespace-nowrap"
                >
